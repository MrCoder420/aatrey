    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Follow Us for Daily Wellness</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {socialLinks.map((social) => (
            <div key={social.name} className="group">
              <Button
                variant="outline"
                className={`w-full h-auto p-6 border-2 border-gray-200 hover:border-transparent transition-all duration-300 ${social.color} hover:text-white group-hover:transform group-hover:scale-105`}
                asChild
              >
                <a href={social.url} target="_blank" rel="noopener noreferrer">
                  <div className="text-center">
                    ...
                    <p className="text-sm opacity-75 mb-2">{social.description}</p>
        ...
        <div className="mt-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-white px-4 py-2 rounded-full shadow-sm">
              <span className="text-green-600 font-semibold">25K+ Community Members</span>
            </div>
            <div className="bg-white px-4 py-2 rounded-full shadow-sm">
              <span className="text-blue-600 font-semibold">Daily Health Tips</span>
            </div>
            <div className="bg-white px-4 py-2 rounded-full shadow-sm">
              <span className="text-purple-600 font-semibold">Recipe Sharing</span>
            </div>
          </div>
        </div>
      </div>
